    ...
    if morePhones == "yes":
        ...
        while inputValidator == False:
            ...
            if buyChoice == "phone":
                ...
                print("The current item(s) in your basket: \n")
                print(*basket, sep = "\n")
                for b in range(len(extendedDeviceBasket)):
                    print(extendedDeviceBasket[b], "\n")
                print("\nYour running total is: ", basketCost, "\n")
                print("-----------------------------------------------------------------------------")
                    ...
                    if 1 <= extendedCaseNum[extraDeviceCounter] <= 16:
                        while inputValidator == False:
                            ...
                            if category[choiceNum] == "Case":
                                ...
                                basketNum[2] = int(input("19 This item is not a case or is unavlailable. Please enter a valid item number to add to your basket: \n--"))
                            inputValidator = True
                ...
                while inputValidator == False:
                    ...
                    if chargerChoice == "yes":
                        ...
                        for b in range(len(extendedDeviceBasket)):
                            ...
                            print(extendedCaseBasket[b])
                            print(extendedChargerBasket[b])
                            print(extendedExtraChargerBasket[b])
                        print("\nYour running total is: ", basketCost, "\n")
                        print("-----------------------------------------------------------------------------")
