...
Python Code for IGCSE 2020 pre-release Task 3
...
discountedPrice = [26.991, 44.991, 179.991, 449.991, 494.991, 584.991, 134.991, 269.991, 449.991, 539.991, 0.00, 9.99, 0.00, 50.00, 19.99, 15.99]
basket = [" ", " ", " ", " ", " "]
basketNum = [" ", " ", " ", " ", " "]
basketCost = 0
choiceNum = 0
...
inputValidator = False
while inputValidator == False:
    morePhones = input("Would you like to purchase additional devices? All additional devices purchased after the first device will have a 10% discount!\n")
    ...
    if morePhones == "yes":
        ...
        while inputValidator == False:
            ...
            if buyChoice == "phone":
                print("The phones available are: \n")
                for i in range(0,6):
                    print(item_number[i], "  ", description[i], " £", discountedPrice[i])
                        ...
                        while inputValidator == False:
                            for j in item_number:
                                if j == extendedDeviceNum[extraDeviceCounter]:
                                    choiceNum = j-1
                            if category[choiceNum] == "Phone":
                                basketCost = basketCost + discountedPrice[choiceNum]
